      ...
      <div style={{ display: "grid", gridTemplateColumns: "180px 1fr", minHeight: 420 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          <div style={{
            ...
            <strong style={{ fontWeight: 600 }}>CS 374 · Lecture 12</strong>
            <span style={{ color: "var(--faint)", fontFamily: "'JetBrains Mono', monospace", fontSize: 11 }}>
              School / CS 374 / Lectures
            </span>
            <div style={{ flex: 1 }}></div>
            <span className="mono" style={{ fontSize: 11, color: "var(--muted)" }}>Session 12</span>
          </div>
          ...
          <div style={{
            ...
            <span className="mono" style={{ fontSize: 12, color: "var(--ink)", minWidth: 48, textAlign: "right" }}>
              {mm}:{ss}
            </span>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", minHeight: 0 }}>
              ...
              <div style={{
                ...
                {visibleNotes.map((b, i) => {
                  ...
                  if (b.type === "li") return <div key={i} className={cls} style={{ fontSize: 13, paddingLeft: 16, position: "relative", margin: "3px 0" }}>
                    <span style={{ position: "absolute", left: 4, color: "var(--accent)" }}>•</span>{b.text}
                  </div>
                  if (b.type === "code") return <div key={i} className={cls} style={{
          ...
          <div style={{
            ...
            <span style={{ color: "var(--ready)" }}>● MPS</span>
            <span>whisper-large-v3</span>
            <span>·</span>
            <span>vault indexed · 247 notes</span>
            <div style={{ flex: 1 }}></div>
            <span style={{ color: "var(--muted)" }}>End Session</span>
          </div>
        </div>
      </div>
    </div>
